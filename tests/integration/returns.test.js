...
// Return 400 if customer/movie ID is not provided
...
describe('/api/returns', () => {
    ...
    it('should return 200 if the rental is processed and returned', async () => {
        const res = await exec();

        expect(res.status).toBe(200);
    });
    it('should set the return date properly', async () => {
        const res = await exec();
    ...
    it('should return the proper daily rental rate', async () =>{
